/**
 * Living location presets for the Job Market page.
 * Ported from dashboard/app.py LIVING_LOCATIONS.
 */
export interface LivingLocation {
  center_zip: string;
  center_lat: number;
  center_lon: number;
  commutable_zips: string[];
}

export const LIVING_LOCATIONS: Record<string, LivingLocation> = {
