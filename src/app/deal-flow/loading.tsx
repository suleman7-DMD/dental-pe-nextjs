...
function SkeletonChart() {
  return (
    <div className="rounded-[10px] border border-[#1E293B] bg-[#0F1629] p-4 animate-pulse">
      ...
      <div className="h-[400px] w-full rounded bg-[#1E293B]" />
    </div>
  )
}
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E] p-6 space-y-6">
      ...
      <div className="animate-pulse">
        <div className="h-8 w-80 rounded bg-[#1E293B] mb-2" />
        <div className="h-4 w-[480px] rounded bg-[#1E293B] mb-1" />
        <div className="h-3 w-48 rounded bg-[#1E293B]" />
      </div>

      {/* Filter bar */}
      <div className="h-14 w-full rounded-[10px] bg-[#0F1629] border border-[#1E293B] animate-pulse" />
