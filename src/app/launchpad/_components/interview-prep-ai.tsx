...
async function fetchInterviewPrep(
  ...
  const requestBody: InterviewPrepRequest = {
    practice: {
      ...
      peer_class: practiceSnapshot.peer_class,
      ownership_tier: practiceSnapshot.ownership_tier,
      census_review_status: practiceSnapshot.census_review_status,
      ownership_confidence: practiceSnapshot.ownership_confidence,
      network: practiceSnapshot.network,
      pe_backed: practiceSnapshot.pe_backed,
      dso_employment_tier: practiceSnapshot.dso_employment_tier,
    },
    signals,
    intel: intel ?? null,
    track: concreteTrack,
