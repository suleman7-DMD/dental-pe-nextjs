...
function SignalCard({
  ...
  return (
    <div className="rounded-lg border border-[#1E293B] bg-[#0A0F1E] p-4">
      ...
      <div className="text-[13px] text-[#CBD5E1] space-y-1">{children}</div>
    </div>
  )
}
    ...
    () => [
      ...
      },
      {
        ...
        render: (val: string | null) => {
          ...
          if (flags.length === 0) return <span className="text-[#475569]">0</span>
          return <span className="text-red-400 font-medium">{flags.length}</span>
        },
      },
      {
        key: 'green_flags',
        ...
        render: (val: string | null) => {
          const flags = safeParseJsonArray(val)
          if (flags.length === 0) return <span className="text-[#475569]">0</span>
          return <span className="text-green-400 font-medium">{flags.length}</span>
        },
      },
      {
        key: 'escalated',
    ...
    <div className="min-h-screen bg-[#0A0F1E] text-[#F8FAFC] font-sans">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6 space-y-6">
        ...
        <div id="zip-intel">
          ...
          {selectedZip && (
            <div className="mt-4 rounded-lg border border-[#1E293B] bg-[#0F1629] p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <SignalCard title="Housing">
                  <p><span className="text-[#94A3B8]">Status:</span> <SignalValue value={selectedZip.housing_status} /></p>
                  <p><span className="text-[#94A3B8]">Developments:</span> <SignalValue value={selectedZip.housing_developments} /></p>
                  <p><span className="text-[#94A3B8]">Summary:</span> <SignalValue value={selectedZip.housing_summary} /></p>
                </SignalCard>

                <SignalCard title="Schools">
                  <p><span className="text-[#94A3B8]">District:</span> <SignalValue value={selectedZip.school_district} /></p>
                  <p><span className="text-[#94A3B8]">Rating:</span> <SignalValue value={selectedZip.school_rating} /></p>
                  <p><span className="text-[#94A3B8]">Source:</span> <SignalValue value={selectedZip.school_source} /></p>
                  <p><span className="text-[#94A3B8]">Note:</span> <SignalValue value={selectedZip.school_note} /></p>
                </SignalCard>

                <SignalCard title="Retail &amp; Income Signals">
                  <p><span className="text-[#94A3B8]">Premium:</span> <SignalValue value={selectedZip.retail_premium} /></p>
                  <p><span className="text-[#94A3B8]">Mass:</span> <SignalValue value={selectedZip.retail_mass} /></p>
                  <p><span className="text-[#94A3B8]">Income Signal:</span> <SignalValue value={selectedZip.retail_income_signal} /></p>
                </SignalCard>

                <SignalCard title="Commercial">
                  <p><span className="text-[#94A3B8]">Status:</span> <SignalValue value={selectedZip.commercial_status} /></p>
                  <p><span className="text-[#94A3B8]">Projects:</span> <SignalValue value={selectedZip.commercial_projects} /></p>
                  <p><span className="text-[#94A3B8]">Note:</span> <SignalValue value={selectedZip.commercial_note} /></p>
                </SignalCard>

                <SignalCard title="Dental News">
                  <p><span className="text-[#94A3B8]">New Offices:</span> <SignalValue value={selectedZip.dental_new_offices} /></p>
                  <p><span className="text-[#94A3B8]">DSO Moves:</span> <SignalValue value={selectedZip.dental_dso_moves} /></p>
                  <p><span className="text-[#94A3B8]">Note:</span> <SignalValue value={selectedZip.dental_note} /></p>
                </SignalCard>

                <SignalCard title="Real Estate">
                  <p>
                    <span className="text-[#94A3B8]">Median Home Price:</span>{' '}
                  ...
                  <p><span className="text-[#94A3B8]">Trend:</span> <SignalValue value={selectedZip.home_price_trend} /></p>
                  <p>
                    <span className="text-[#94A3B8]">YoY Change:</span>{' '}
                    {selectedZip.home_price_yoy_pct != null ? (
                      <span className={selectedZip.home_price_yoy_pct >= 0 ? 'text-green-400' : 'text-red-400'}>
                  ...
                  <p><span className="text-[#94A3B8]">Source:</span> <SignalValue value={selectedZip.real_estate_source} /></p>
                </SignalCard>

                <SignalCard title="Zoning &amp; Planning">
                  <p><span className="text-[#94A3B8]">Items:</span> <SignalValue value={selectedZip.zoning_items} /></p>
                  <p><span className="text-[#94A3B8]">Note:</span> <SignalValue value={selectedZip.zoning_note} /></p>
                </SignalCard>

                <SignalCard title="Population">
                  <p><span className="text-[#94A3B8]">Growth Signals:</span> <SignalValue value={selectedZip.pop_growth_signals} /></p>
                  <p><span className="text-[#94A3B8]">Demographics:</span> <SignalValue value={selectedZip.pop_demographics} /></p>
                  <p><span className="text-[#94A3B8]">Note:</span> <SignalValue value={selectedZip.pop_note} /></p>
                </SignalCard>

                <SignalCard title="Employers &amp; Insurance">
                  <p><span className="text-[#94A3B8]">Major Employers:</span> <SignalValue value={selectedZip.major_employers} /></p>
                  <p><span className="text-[#94A3B8]">Insurance Signal:</span> <SignalValue value={selectedZip.insurance_signal} /></p>
                </SignalCard>

                <SignalCard title="Competitors">
                  <p><span className="text-[#94A3B8]">New:</span> <SignalValue value={selectedZip.competitor_new} /></p>
                  <p><span className="text-[#94A3B8]">Closures:</span> <SignalValue value={selectedZip.competitor_closures} /></p>
                  <p><span className="text-[#94A3B8]">Note:</span> <SignalValue value={selectedZip.competitor_note} /></p>
                </SignalCard>
              </div>
              ...
              <div className="space-y-4">
                ...
                {selectedZip.sources && (
                  <div className="rounded-lg border border-[#1E293B] bg-[#0A0F1E] p-4">
                    ...
                    <ul className="text-[13px] text-[#CBD5E1] space-y-1">
                      {safeParseJsonArray(selectedZip.sources).length > 0 ? (
                        safeParseJsonArray(selectedZip.sources).map((src, i) => (
                          <li key={i} className="flex items-center gap-1.5">
                            <ExternalLink className="h-3 w-3 text-[#475569] flex-shrink-0" />
                            <span>{src}</span>
                          </li>
                        ))
                      ) : (
                        <li className="text-[#CBD5E1]">{selectedZip.sources}</li>
                      )}
                    </ul>
                  </div>
                )}
            ...
            <div className="mt-4 rounded-lg border border-[#1E293B] bg-[#0F1629] p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <SignalCard title="Website Analysis">
                  ...
                  <p><span className="text-[#94A3B8]">Era:</span> <SignalValue value={selectedPractice.website_era} /></p>
                  <p><span className="text-[#94A3B8]">Last Update:</span> <SignalValue value={selectedPractice.website_last_update} /></p>
                  <p><span className="text-[#94A3B8]">Analysis:</span> <SignalValue value={selectedPractice.website_analysis} /></p>
                </SignalCard>

                <SignalCard title="Services">
                  <p><span className="text-[#94A3B8]">Listed:</span> <SignalValue value={selectedPractice.services_listed} /></p>
                  <p><span className="text-[#94A3B8]">High Revenue:</span> <SignalValue value={selectedPractice.services_high_rev} /></p>
                  <p><span className="text-[#94A3B8]">Note:</span> <SignalValue value={selectedPractice.services_note} /></p>
                </SignalCard>

                <SignalCard title="Technology">
                  <p><span className="text-[#94A3B8]">Listed:</span> <SignalValue value={selectedPractice.technology_listed} /></p>
                  <p><span className="text-[#94A3B8]">Level:</span> <SignalValue value={selectedPractice.technology_level} /></p>
                </SignalCard>
                ...
                <SignalCard title="Google Reviews">
                  ...
                  <p><span className="text-[#94A3B8]">Recent Date:</span> <SignalValue value={selectedPractice.google_recent_date} /></p>
                  <p><span className="text-[#94A3B8]">Velocity:</span> <SignalValue value={selectedPractice.google_velocity} /></p>
                  <p><span className="text-[#94A3B8]">Sentiment:</span> <SignalValue value={selectedPractice.google_sentiment} /></p>
                </SignalCard>

                <SignalCard title="Hiring Signals">
                  <p>
                    <span className="text-[#94A3B8]">Active Hiring:</span>{' '}
                  ...
                  <p><span className="text-[#94A3B8]">Positions:</span> <SignalValue value={selectedPractice.hiring_positions} /></p>
                  <p><span className="text-[#94A3B8]">Source:</span> <SignalValue value={selectedPractice.hiring_source} /></p>
                </SignalCard>

                <SignalCard title="Acquisition News">
                  <p>
                    <span className="text-[#94A3B8]">Found:</span>{' '}
                  ...
                  <p><span className="text-[#94A3B8]">Details:</span> <SignalValue value={selectedPractice.acquisition_details} /></p>
                </SignalCard>

                <SignalCard title="Social Media">
                  <p><span className="text-[#94A3B8]">Facebook:</span> <SignalValue value={selectedPractice.social_facebook} /></p>
                  <p><span className="text-[#94A3B8]">Instagram:</span> <SignalValue value={selectedPractice.social_instagram} /></p>
                  <p><span className="text-[#94A3B8]">Other:</span> <SignalValue value={selectedPractice.social_other} /></p>
                </SignalCard>

                <SignalCard title="Provider Profile">
                  <p>
                    <span className="text-[#94A3B8]">Provider Count (Web):</span>{' '}
                  ...
                  <p><span className="text-[#94A3B8]">Career Stage:</span> <SignalValue value={selectedPractice.owner_career_stage} /></p>
                  <p><span className="text-[#94A3B8]">Publications:</span> <SignalValue value={selectedPractice.doctor_publications} /></p>
                  <p><span className="text-[#94A3B8]">Speaking:</span> <SignalValue value={selectedPractice.doctor_speaking} /></p>
                  <p><span className="text-[#94A3B8]">Associations:</span> <SignalValue value={selectedPractice.doctor_associations} /></p>
                  <p><span className="text-[#94A3B8]">Notes:</span> <SignalValue value={selectedPractice.doctor_notes} /></p>
                </SignalCard>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="rounded-lg border border-[#1E293B] bg-[#0A0F1E] p-4">
                  <h4 className="text-[11px] font-semibold uppercase tracking-wider text-red-400 mb-2 flex items-center gap-1.5">
                    <AlertTriangle className="h-3.5 w-3.5" />
                    Red Flags
                  </h4>
                  {safeParseJsonArray(selectedPractice.red_flags).length > 0 ? (
                    <ul className="text-[13px] text-red-300 space-y-1">
                    ...
                    <p className="text-[13px] text-[#475569]">None identified</p>
                  )}
                </div>

                <div className="rounded-lg border border-[#1E293B] bg-[#0A0F1E] p-4">
                  <h4 className="text-[11px] font-semibold uppercase tracking-wider text-green-400 mb-2 flex items-center gap-1.5">
                    <CheckCircle2 className="h-3.5 w-3.5" />
                    Green Flags
                  </h4>
                  {safeParseJsonArray(selectedPractice.green_flags).length > 0 ? (
                    <ul className="text-[13px] text-green-300 space-y-1">
              ...
              {/* Overall assessment */}
              <div className="rounded-lg border border-[#1E293B] bg-[#0A0F1E] p-4 mb-4">
                <h4 className="text-[11px] font-semibold uppercase tracking-wider text-[#94A3B8] mb-2">
                  Overall Assessment
                </h4>
                <p className="text-[13px] text-[#CBD5E1]">
              ...
              {selectedPractice.escalated === 1 && selectedPractice.escalation_findings && (
                <div className="rounded-lg border border-blue-500/30 bg-blue-500/5 p-4 mb-4">
                  <h4 className="text-[11px] font-semibold uppercase tracking-wider text-blue-400 mb-2">
              ...
              <div className="flex flex-wrap items-center gap-4 text-[11px] text-[#64748B]">
                ...
                {selectedPractice.escalated === 1 && (
                  <span className="text-blue-400">Two-pass escalated</span>
                )}
              </div>
            </div>
          )}
