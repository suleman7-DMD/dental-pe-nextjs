  ...
  return (
    <div className="space-y-4">
      ...
      <textarea
        ...
        className="w-full h-[150px] rounded-md border border-[#E8E5DE] bg-[#2C2C2C] text-[#F5F5F0] px-3 py-2 text-sm font-mono resize-y focus:outline-none focus:ring-2 focus:ring-[#B8860B] placeholder:text-[#8F8E82]"
      />
