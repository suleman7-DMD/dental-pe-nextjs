  ...
  return (
    <div className="min-h-screen bg-[#0B1121] p-6 space-y-6">
      ...
      <div className="animate-pulse">
        <div className="h-8 w-48 rounded bg-[#1E2A3A] mb-2" />
        <div className="h-4 w-[420px] rounded bg-[#1E2A3A]" />
      </div>

      {/* Tabs */}
      <div className="flex gap-2 animate-pulse">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="h-9 w-36 rounded bg-[#1E2A3A]" />
        ))}
      </div>
      ...
      {/* KPI */}
      <div className="h-20 w-full rounded-[10px] border border-[#1E2A3A] bg-[#141922] animate-pulse" />

      {/* Chart placeholder */}
      <div className="rounded-[10px] border border-[#1E2A3A] bg-[#141922] animate-pulse">
        <div className="h-[350px] w-full rounded bg-[#1E2A3A]" />
      </div>
