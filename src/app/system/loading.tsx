  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E] p-6 space-y-6">
      ...
      <div className="animate-pulse">
        <div className="h-8 w-44 rounded bg-[#1E293B] mb-2" />
        <div className="h-4 w-[400px] rounded bg-[#1E293B]" />
      </div>
      ...
      {/* Manual entry forms */}
      <div className="rounded-[10px] border border-[#1E293B] bg-[#0F1629] p-4 animate-pulse">
        <div className="h-4 w-40 rounded bg-[#1E293B] mb-4" />
        <div className="h-[200px] w-full rounded bg-[#1E293B]" />
      </div>
    </div>
  )
}
